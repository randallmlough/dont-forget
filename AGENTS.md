...
- Standard TS/TSX proof: `make verify` runs `typecheck -> biome-check -> eslint-rules -> lint -> test-ci`. Full CI parity: `make ci` adds Expo package check, public config resolution, and high-severity audit.
