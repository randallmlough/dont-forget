...
- `src/client/` — the iOS app: `src/client/features/<feature>/` (screens, hooks, feature services), `src/client/session/` (Authenticated App Session + PowerSync), `src/client/lib/`, `src/client/theme/`, `src/client/ui/`.
