import type { AuthenticatedAppSessionBootstrapDeps } from "@/server/bootstrap/bootstrap-service";
import {
...
import { type DirectoryDb, postgresPool } from "@/server/db/client";
import {
...
jest.mock("@/server/bootstrap/bootstrap-service", () => ({
