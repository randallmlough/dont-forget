...
Co-locate stories next to the component or view they describe under `apps/mobile/src/`. Use a separate top-level stories folder only for cross-component compositions that do not belong to a single component.
