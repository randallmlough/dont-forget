...
Project-specific background can stay in `docs/how-things-work/`; procedural playbooks belong in `docs/workflows/`. This directory should link to those pages when they explain context or workflows. When a rule is meant to be enforced during normal implementation or review, capture it here.
...
- `docs/workflows/` for procedural playbooks such as planning, feature development, QA, debugging, and code review.
