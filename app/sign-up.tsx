...
export default function SignUpScreen() {
  ...
  return (
    <AuthScreen title="Create your account" subtitle="Join your household in seconds.">
      <SocialSignIn />
      <OrDivider />
      <CreateAccountForm onPendingVerification={setPendingEmail} />
      <AuthFooterLink prompt="Already have an account?" label="Sign in" href="/sign-in" />
    </AuthScreen>
  );
}

function CreateAccountForm({ onPendingVerification }: { onPendingVerification: (email: string) => void }) {
  ...
  return (
    <>
      ...
      />
      <PrimaryButton label="Create account" onPress={onCreate} loading={submitting} />
    </>
  );
}
...
function VerifyEmailForm({ onBack }: { onBack: () => void }) {
  ...
  return (
    <>
      ...
      />
      <PrimaryButton label="Verify email" onPress={onVerify} loading={submitting} />
      <Pressable onPress={onBack} disabled={submitting} style={styles.backButton}>
