...
export const SignIn: Story = {
  render: () => (
    <AuthScreen title="Don't Forget" subtitle="Shared Lists for your Household.">
      <AuthTextInput
        placeholder="Email"
        autoComplete="email"
...
export const Verification: Story = {
  render: () => (
    <AuthScreen title="Create your account" subtitle="We sent a verification code to avery@example.com.">
      <AuthTextInput
