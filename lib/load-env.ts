...
import { parseAppEnv, type AppEnv } from "./env.ts";
...
export function loadEnvFile(options: { requireAppEnv: false }): AppEnv | undefined;
export function loadEnvFile(options: LoadEnvFileOptions = {}): AppEnv | undefined {
